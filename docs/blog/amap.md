...
![5](/img/blog/amap/5.png)

- Text 类

文本标注，可以添加自定义样式的文本。

![6](/img/blog/amap/6.png)

- Polyline 类

折线

![7](/img/blog/amap/7.png)

- Polygon 类

多边形

![8](/img/blog/amap/8.png)

- BezierCurve 类

贝塞尔曲线

![9](/img/blog/amap/9.png)

- Circle 类

圆形

![10](/img/blog/amap/10.png)
